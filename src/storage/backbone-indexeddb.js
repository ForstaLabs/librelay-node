...
const _engine = new sqlite3.Database(':memory:'); // XXX probably persist?
const indexedDB = new indexeddb.indexedDB('sqlite3', _engine);
...
if (typeof indexedDB === "undefined") {
    throw new Error("indexeddb is not setup");
}
...
Driver.prototype = {
    ...
    query: function (storeName, collection, options) {
        ...
        throw new Error("find IDBCUrsor.PREV"); // XXX
