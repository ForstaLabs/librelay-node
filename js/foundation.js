...
const textsecure_worker = require('./libsignal-protocol-worker.js');
console.dir(textsecure_worker);
...
var messageReceiver;
exports.getSocketStatus = function() {
    if (messageReceiver) {
...
storage.onready(function() {
    eventEmitter.emit('storage_ready');
    setUnreadCount(storage.get("unreadCount", 0));
});

exports.getSyncRequest = function() {
    return new textsecure.SyncRequest(textsecure.messaging, messageReceiver);
};

exports.initFoundation = function(firstRun) {
    exports.removeEventListener('online', initFoundation);
    ...
    exports.textsecure.messaging = new textsecure.MessageSender(
    ...
    if (firstRun === true && textsecure.storage.user.getDeviceId() != '1') {
        ...
        syncRequest.addEventListener('success', function() {
            ...
            exports.dispatchEvent(new Event('textsecure:contactsync'));
        });
